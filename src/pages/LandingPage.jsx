        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex space-x-4">
              <Link to="/signin" className="text-gray-700 hover:text-green-600 transition font-medium">
                Sign In
              </Link>
      ...
      <section className="py-20 bg-gradient-to-r from-green-600 to-blue-600">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex justify-center space-x-4">
            ...
            <Link to="/signup" className="bg-green-700 text-white px-8 py-4 rounded-lg font-semibold hover:bg-green-800 transition text-lg border-2 border-white">
              Become a Worker
            </Link>
          </div>
        </div>
